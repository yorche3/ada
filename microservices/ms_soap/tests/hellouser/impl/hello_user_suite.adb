...
package body Hello_User_Suite is
   ...
   begin
      ...
      Ret.Add_Test (Caller.Create ("Missing Envelope",       Test_Missing_Envelope'Access));
      Ret.Add_Test (Caller.Create ("Missing Body",           Test_Missing_Body'Access));
      Ret.Add_Test (Caller.Create ("Missing greetings",      Test_Missing_Greetings'Access));
      ...
      Ret.Add_Test (Caller.Create ("Malformed name tag",     Test_Malformed_Name_Tag'Access));
